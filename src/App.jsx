...
const PROJECTS = [
  {
    ...
    stack: ['Next.js', 'TypeScript', 'Tailwind', 'OpenAI', 'Supabase'],
    // صور وهمية (Placeholders) لحد ما تحط صورك الحقيقية
    images: [
      "https://images.unsplash.com/photo-1555066931-4365d14bab8c?q=80&w=1000&auto=format&fit=crop", // صورة رئيسية
      "https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=1000&auto=format&fit=crop", // صورة داشبورد
      "https://images.unsplash.com/photo-1517694712202-14dd9538aa97?q=80&w=1000&auto=format&fit=crop"  // صورة كود
    ],
    links: { demo: "#", repo: "#" }
  }
];
...
function App() {
  ...
  const [selectedProject, setSelectedProject] = useState(null); // 🆕 حالة لتخزين المشروع المختار
  ...
  <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-40 animate-fade-in-up w-auto max-w-[90%]">
    <div className={`flex items-center justify-between gap-1 md:gap-2 px-4 py-3 md:px-6 md:py-3 rounded-2xl border transition-all duration-500 shadow-2xl ${
      isDarkMode 
        ...
        <DockItem icon="fab fa-x-twitter" label="Twitter" href="https://x.com/xx_abdulll" isDarkMode={isDarkMode} />
